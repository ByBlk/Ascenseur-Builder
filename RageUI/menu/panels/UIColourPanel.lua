---@type table
local Colour = {
    Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 444, Height = 112 },
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 7.5, Y = 15, Width = 20, Height = 20 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 406.5, Y = 15, Width = 20, Height = 20 },
