...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "commonmenutu", Texture = "arrowleft", X = 217, Y = 11.5, Width = 10, Height = 10 },
    RightArrow = { Dictionary = "commonmenutu", Texture = "arrowright", X = 362, Y = 11.5, Width = 10, Height = 10 },
}
