...
local SettingsButton = {
    ...
    RightText = { X = 432, Y = 4, Scale = 0.20  },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 444, Height = 35 },
}

---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 398, Y = 3, Width = 20, Height = 20 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 420, Y = 3, Width = 20, Height = 20 },
